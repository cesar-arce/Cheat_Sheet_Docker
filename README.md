...
3. [Building Images](#Building_Images)
    a. [Build Images](#Build_Images1)
        1. [Removing a Single Image](#Removing_Single_Image1)
        2. [Options](#Options1)
        3. [Pruning Containers and Images](#Pruning_Containers_Images1)
        4. [Forcefully Remove Containers and Images ](#Forcefully_Remove_Containers_Images1)			
...
9. [Docker Hub](#Docker_Hub)
    a. [After modify your python script](#After_modify_python_script)
